...
public class QL_PhongHoc extends JFrame {
 ...
 public QL_PhongHoc() {
        ...
        northPanel.add(panelHeader, BorderLayout.NORTH); // Thêm panelHeader
        northPanel.add(buttonPanel, BorderLayout.SOUTH); // Thêm buttonPanel

        // Thêm northPanel vào BorderLayout.NORTH
